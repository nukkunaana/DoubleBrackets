$(function () { 	
	...
	var go_action = false;
	// при нажатии на категорию в меню, функция показывает соответствующее содержимое , при этом скрывая не нужное. Плюс, окно не выплывает наверх, а остается статично. Плюс, красим в зеленый название той категории в которой находимся.
	$(".select_categoryMenu a").click(function(event){
		event.preventDefault();
		// действует анимация по сверствованию и открыванию ссылки в это время ничего нельзя нажимать
		if (go_action == false) {
